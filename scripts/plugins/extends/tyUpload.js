...
define("tyUpload", function () {
    ...
    function init(config) {
        ...
        var defaultConfig = {
            ...
            buttonText: "上传附件",
            iconClass: {
                "buttonIconUpload": "iconfont icon-shangchuan1",
                "iconUpload": "iconfont icon-shangchuan",
                "iconPlus": "iconfont icon-xinzeng",
                "iconCheck": "iconfont icon-weibiaoti14",
                "iconClose": "iconfont icon-guanbi1",
                "iconCircleCheck": "iconfont icon-qiyong_normal",
                "iconPicture": "iconfont icon-tupian",
                "iconDocument": "iconfont icon-declare",
                "iconZoomIn": "iconfont icon-chazhao2",
                "iconDelete": "iconfont icon-shanchu3",
                "iconLoading": "iconfont icon-jiazai"
            }
        };
