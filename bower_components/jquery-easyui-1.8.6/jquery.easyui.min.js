...
var t=$(_d1);
return $.extend({},$.parser.parseOptions(_d1,[{total:"number",pageSize:"number",pageNumber:"number",links:"number"},{loading:"boolean",showPageList:"boolean",showPageInfo:"boolean",showRefresh:"boolean"}]),{pageList:(t.attr("pageList")?eval(t.attr("pageList")):undefined)},{layout:['info','list','prev','links','next',"manual"]});
};
...
if(!opts.buttons){
opts.buttons=[{text:opts.cancel,onClick:function(){
_2c9(dlg,false);
}},{text:opts.ok,cls: "btn-primary",onClick:function(){
        _2c9(dlg,true);
    }}];
}
var dlg=_2ce(opts);
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,interval:200,missingMessage:"This field is required.",invalidMessage:null,tipPosition:"bottom",deltaX:0,deltaY:0,novalidate:false,editable:true,disabled:false,readonly:false,validateOnCreate:true,validateOnBlur:false,events:{focus:_545,blur:_549,mouseenter:_54c,mouseleave:_54f,click:function(e){
var t=$(e.data.target);
...
if(opts.multiline){
$("<label class='textbox-text-label' for="+_580+"></label><textarea id=\""+_580+"\" class=\"textbox-text\" autocomplete=\"off\"></textarea>").prependTo(tb);
}else{
$("<label class='textbox-text-label' for="+_580+"></label><input id=\""+_580+"\" type=\""+opts.type+"\" class=\"textbox-text\" autocomplete=\"off\">").prependTo(tb);
}
...
$.fn.textbox.defaults=$.extend({},$.fn.validatebox.defaults,{doSize:true,width:180,height:"auto",cls:null,prompt:"",value:"",type:"text",multiline:false,icons:[],iconCls:null,iconAlign:"right",iconWidth:26,buttonText:"",buttonIcon:null,buttonAlign:"right",label:null,labelWidth:"auto",labelPosition:"before",labelAlign:"left",inputEvents:{blur:function(e){
var t=$(e.data.target);
...
t.find(".calendar-body")._outerHeight(opts.height-t.find(".calendar-header")._outerHeight());
...
if(!_ae3.panel){
 if(opts.multiple){
        _ae3.panel=$("<div class=\"combo-panel combo-multiple\"></div>").appendTo("body");
    }else{
...
_b01.panel("panel").show().css({zIndex:($.fn.menu?$.fn.menu.defaults.zIndex++:($.fn.window?$.fn.window.defaults.zIndex++:99)),left:-999999});
   var _h = Number(opts.panelHeight) > 137 ? 140 : "auto";
_b01.panel("resize",{width:(opts.panelWidth?opts.panelWidth:_b00._outerWidth()),height:_h});
...
_c7d(this,q);
},parser:myparser},currentText:"今天",closeText:"关闭",okText:"确定",buttons:[{text:function(_c92){
