...
if(!_4.panel){
    if(_5.multiple){
        _4.panel=$("<div class=\"combo-panel combo-multiple\"></div>").appendTo("body");
    }else{
...
var _h = Number(_27.panelHeight) > 137 ? 140 : "auto";
_26.panel("resize",{width:(_27.panelWidth?_27.panelWidth:_25._outerWidth()),height:_h});
