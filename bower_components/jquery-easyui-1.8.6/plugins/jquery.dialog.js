...
var p=_3.buttons[i];
var _9=_3.buttons[i].cls?$("<a href=\"javascript:;\" class="+_3.buttons[i].cls+"></a>").appendTo(_8):$("<a href=\"javascript:;\"></a>").appendTo(_8);
if(p.handler){
...
$.fn.dialog.defaults=$.extend({},$.fn.window.defaults,{title:"新窗口",collapsible:false,minimizable:false,maximizable:false,resizable:false,toolbar:null,buttons:null});
})(jQuery);
