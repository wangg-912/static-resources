                            ...
                            if (_8 == "manual") {
                                ...
                                if (_8 == "refresh") {
                                    ...
                                    if (_8 == "links") {
                                        ...
                                        if (_8 == "inline") {
                                            $("<td style='width: 0;'></td>").appendTo(tr);
                                        } else {
                                            if (_8 == "info") {
                                                if (_7 == aa.length - 1) {
...
var t=$(_28);
return $.extend({},$.parser.parseOptions(_28,[{total:"number",pageSize:"number",pageNumber:"number",links:"number"},{loading:"boolean",showPageList:"boolean",showPageInfo:"boolean",showRefresh:"boolean"}]),{pageList:(t.attr("pageList")?eval(t.attr("pageList")):undefined)},{layout:['info','list','inline','prev','links','next',"manual"],links:5});
};
