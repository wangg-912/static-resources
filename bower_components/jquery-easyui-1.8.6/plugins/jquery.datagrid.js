...
}, resizeExt:function (jq) {
        return jq.each(function () {
            var _209 = this;
            var options = $(_209).datagrid("options");
            var excWidth = options.excWidth || 0;// 水平排除 数�?
            var excHeight = options.excHeight || 0;// 垂直排除 数�?
            ...
            $(jq).datagrid('resize', {
                width : bodyWidth - excWidth,
                height : bodyHeight - excHeight
            });
        })
    }
};
