...
function myparser(s){
    ...
    var ss = (s.split('-')),y = parseInt(ss[0],10),m = parseInt(ss[1],10),d = parseInt(ss[2],10);
...
$.fn.datebox.defaults=$.extend({},$.fn.combo.defaults,{panelWidth:200,panelMinHeight:200,sharedCalendar:null,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
_16(this,q);
},parser:myparser},currentText:"今天",closeText:"关闭",okText:"确定",buttons:[{text:function(_30){
