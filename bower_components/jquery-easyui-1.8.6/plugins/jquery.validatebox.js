...
},message:"请输入有效的电子邮件地址ַ."},url:{validator:function(_43){
...
},message:"请输入有效的URL地址."},length:{validator:function(_44,_45){
var len=$.trim(_44).length;
return len>=_45[0]&&len<=_45[1];
},message:"输入内容长度必须介于{0}和{1}之间."},remote:{validator:function(_46,_47){
var _48={};
_48[_47[1]]=_46;
var _49=$.ajax({
url:_47[0],
